...
@Disabled
public class AuthorControllerTestITHal extends BaseControllerTestIT<Author, Long> {
    ...
    public void setUp() {
        ...
        halRestTemplate = new RestTemplate();
            List<HttpMessageConverter<?>> existingConverters = halRestTemplate.getMessageConverters();
            List<HttpMessageConverter<?>> newConverters = new ArrayList<>();
            newConverters.add(halConverter);
            newConverters.addAll(existingConverters);
        halRestTemplate.setMessageConverters(newConverters);*/
    }
