...
public abstract class TestHelper {
    ...
    public static final Book BOOK1 = new Book(1L, "isbn1", "title1", "desc1");
    public static final Book BOOK2 = new Book(2L, "isbn2", "title2", "desc2");

    public static final Magazine MAGAZINE1  = new Magazine(3L, "isbn3", "title3", RELEASE_DATE_TEST.plusDays(1L) );
    public static final Magazine MAGAZINE2 = new Magazine(4L, "isbn4", "title4", RELEASE_DATE_TEST.plusDays(2L));
    ...
    public static final BookDTO BOOKDTO1 = new BookDTO(1L, "isbn1", "title1", "desc1", new HashSet<>(), BookController.FINDBYID_PATH + "1");
    public static final BookDTO BOOKDTO2 = new BookDTO(2L, "isbn2", "title2", "desc2", new HashSet<>(), BookController.FINDBYID_PATH + "2");

    public static final MagazineDTO MAGAZINEDTO1 = new MagazineDTO(3L, "isbn3", "title3", RELEASE_DATE_TEST.plusDays(1L), new HashSet<>(), MagazineController.FINDBYID_PATH + "3");
    public static final MagazineDTO MAGAZINEDTO2 = new MagazineDTO(4L, "isbn4", "title4", RELEASE_DATE_TEST.plusDays(2L), new HashSet<>(), MagazineController.FINDBYID_PATH + "4");
